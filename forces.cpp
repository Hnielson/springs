...
SpringForce::SpringForce(Particle* p1_temp, 
						 ...
						 double damping_constant_temp, int red, int green, int blue,
...
int SpringForce::GetRed()
{
	return mRed;
}

int SpringForce::GetGreen()
{
	return mGreen;
}

int SpringForce::GetBlue()
{
	return mBlue;
}

void SpringForce::SetRed(int red)
{
	mRed = red % 256;
}

void SpringForce::SetGreen(int green)
{
	mGreen = green % 256;
}

void SpringForce::SetBlue(int blue)
{
	mBlue = blue % 256;
}
